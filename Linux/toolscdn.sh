...
function rootlogin(){
    ...
    case "$rootNumberInput" in
        1 ) 
		bash -c "$(curl -fsSL https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/root.sh)"
		;;
        2 ) 
		bash -c "$(curl -fsSL https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/useradd.sh)"
		;;
        3 ) 
		bash -c "$(curl -fsSL https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/userdel.sh)"
		;;
        0 ) page1
    esac
}
...
function swap(){
  bash <(curl -sSL https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/swap.sh)
}

function ssh_port(){
  bash <(curl -sSL https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/ssh_port.sh)
}
...
function bbr(){
    ...
    case "$bbrNumberInput" in
        1 ) 
		wget -N --no-check-certificate "https://cdn.wen124.ml/https://raw.githubusercontent.com/chiakge/Linux-NetSpeed/master/tcp.sh" && chmod +x tcp.sh && ./tcp.sh && rm tcp.sh
		;;
        2 ) 
		wget -N --no-check-certificate "https://cdn.wen124.ml/https://raw.githubusercontent.com/ylx2016/Linux-NetSpeed/master/tcp.sh" && chmod +x tcp.sh && ./tcp.sh && rm tcp.sh
		;;
        3 ) 
...
function cssh(){
wget -O "/root/changesource.sh" "https://cdn.wen124.ml/https://raw.githubusercontent.com/Netflixxp/jcnf-box/master/sh/changesource.sh" --no-check-certificate -T 30 -t 5 -d
...
function server-test(){
  bash -c "$(curl -fsSL https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/server-test.sh)"
}

function gfw_push(){
  bash -c "$(curl -fsSL https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/gfw_push.sh)"
}
...
function unlock(){
    ...
    case "$unlockNumberInput" in
		1)
		bash -c "$(curl -fsSL https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/netflix.sh)"
		;;
		2)
		bash -c "$(curl -fsSL https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/disney.sh)"
		;;
		3)
	    bash -c "$(curl -fsSL https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/tubecheck.sh)"
		;;
		4)
		bash <(curl -L -s https://cdn.wen124.ml/https://raw.githubusercontent.com/lmc999/RegionRestrictionCheck/main/check.sh)
		;;
        0 ) page2
    esac
}
...
function speedtest(){
  bash -c "$(curl -fsSL https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/speedtest.sh)"
}
...
function baota7(){
   wget https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/LinuxPanel-7.7.0.zip && unzip LinuxPanel-7.7.0.zip && cd /root/panel && bash update.sh && rm -rf LinuxPanel-7.7.0.zip  /root/panel
}
...
function nezha(){
  curl -L https://cdn.wen124.ml/https://raw.githubusercontent.com/naiba/nezha/master/script/install.sh  -o nezha.sh && chmod +x nezha.sh
...
function nginxpm(){
bash -c "$(curl -fsSL  https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/Docker/Docker-Compose/Nginx-Proxy-Manager/nginx-proxy-manager.sh)"
}

function watchtower(){
bash -c "$(curl -fsSL  https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/Docker/watchtowersh)"
}

function syncthing(){
bash -c "$(curl -fsSL  https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/Docker/syncthing.sh)"
}

function alistdocker(){
bash -c "$(curl -fsSL  https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/Docker/alist.sh)"
}

function qinglong(){
bash -c "$(curl -fsSL  https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/Docker/qinglong.sh)"
}

function easyimage(){
bash -c "$(curl -fsSL  https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/Docker/easyimage.sh)"
}
...
function odocker(){
    ...
    case "$odockerNumberInput" in
		1)
		bash -c "$(curl -fsSL https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/Docker/qiandao.sh)"
		;;
		2)
		bash -c "$(curl -fsSL https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/Docker/feiyangiptv.sh)"
		;;
		3)
		bash -c "$(curl -fsSL https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/Docker/freenom.sh)"
		;;
		4)
		bash -c "$(curl -fsSL https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/Docker/halo.sh)"
		;;
		5)
		bash -c "$(curl -fsSL https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/Docker/reader.sh)"
		;;
		6)
...
function compose(){
    ...
    case "$composeNumberInput" in
		1)
		bash -c "$(curl -fsSL https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/Docker/Docker-Compose/Easyimage/easyimage.sh)"
		;;
		2)
		bash -c "$(curl -fsSL https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/Docker/Docker-Compose/YOURLS/yourls.sh)"
		;;
		3)
		bash -c "$(curl -fsSL https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/Docker/Docker-Compose/Reader/reader.sh)"
		;;
		4)
		bash -c "$(curl -fsSL https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/Docker/Docker-Compose/WikiJS/wikijs.sh)"
		;;
		5)
		bash -c "$(curl -fsSL https://gwen124.ml/tools.sh)"
		;;
...
#page5
function xui(){
    bash <(curl -Ls https://cdn.wen124.ml/https://raw.githubusercontent.com/vaxilu/x-ui/master/install.sh)
}

function trojanui(){
    bash <(curl -Ls https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/trojan-install.sh)
}

function xray(){
    bash <(curl -sL https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/xray.sh)
}
...
if [ "$(uname -m)" = "x86_64" ]; then
  wget https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/FRPS/AMD-install-frps.sh -O ./install-frps.sh && rm -r install-frps.sh
elif [ "$(uname -m)" = "aarch64" ]; then
  wget https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/FRPS/ARM-install-frps.sh -O ./install-frps.sh && rm -r install-frps.sh
else
  echo "未知的系统架构"
fi
}
...
function dnat(){
  bash <(curl -fsSL https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/dnat.sh)
}

function gost(){
  wget --no-check-certificate -O gost.sh https://cdn.wen124.ml/https://raw.githubusercontent.com/KANIKIG/Multi-EasyGost/master/gost.sh && chmod +x gost.sh && ./gost.sh && rm -rf gost.sh
}
...
function aria2(){
  bash <(curl -fsSL https://cdn.wen124.ml/https://raw.githubusercontent.com/GWen124/Script/master/Linux/aria2.sh)
}
