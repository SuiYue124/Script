...
function op_common_sh() {
  ...
  curl -L https://raw.githubusercontent.com/GWen124/Openwrt-Common/master/common.sh > common.sh
  if [[ $? -ne 0 ]];then
    wget -O common.sh https://raw.githubusercontent.com/GWen124/Openwrt-Common/master/common.sh
  fi
  if [[ $? -eq 0 ]];then
    chmod +x common.sh
